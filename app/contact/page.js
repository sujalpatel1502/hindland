        ...
        <div className="relative z-10 max-w-screen-2xl mx-auto px-8 w-full">
          <div className="max-w-3xl">
            ...
            <p className="text-surface-container-highest font-body text-xl md:text-2xl leading-relaxed max-w-2xl">
              Partner with Hindland Infrastructure for precision-engineered
              solutions that redefine industrial standards.
            </p>
          </div>
        </div>
          ...
          <div className="lg:col-span-5 bg-primary-container p-10 md:p-16 text-white flex flex-col justify-between">
              ...
              <div className="space-y-12">
                ...
                <div className="flex gap-6">
                  ...
                  <div>
                    ...
                    <p className="text-surface-container-lowest font-body text-xl font-medium">
                      <Link
                        href="mailto:inquiries@hindland.com"
                        className="text-inherit hover:underline"
                      >
                        inquiries@hindland.com
                      </Link>
                    </p>
                  </div>
                </div>
            ...
            <div className="mt-16 pt-10 border-t border-white/10">
              <p className="font-label text-xs uppercase tracking-widest opacity-60">
                Emergency Support Available 24/7 for On-Site Contract
                Partners.
              </p>
            </div>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-12 gap-12 items-center">
            <div className="md:col-span-4">
              ...
              <p className="text-on-surface-variant leading-relaxed mb-8">
                Our offices are strategically located near major industrial hubs
                to ensure rapid mobilization and consistent project oversight.
              </p>
              <div className="space-y-4">
                ...
                <div className="p-4 bg-white/50 rounded-lg">
                  <p className="font-headline font-bold text-stone-700">
                    Houston Hub
                  </p>
                  <p className="text-sm text-stone-500">
                    Logistics & Engineering Unit
                  </p>
                </div>
              </div>
            </div>
      ...
      <section className="bg-primary py-20">
        <div className="max-w-screen-2xl mx-auto px-8 text-center">
          <h2 className="text-white font-headline text-4xl md:text-5xl font-black tracking-tight mb-8">
            Ready to start your next monolith?
          </h2>
          <button
